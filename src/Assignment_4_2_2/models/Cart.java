...
import Assignment_4_2_1.models.CartItems;
...
public class Cart {
    ...
    public void add(Product product, float quantity) {
        ...
        //Adding for first time
            ...
            Assignment_4_2_1.models.CartItems item = new Assignment_4_2_1.models.CartItems(product.name, product.pricePerKg, quantity);
    ...
    public void add(Product product, Variant variant) {
        ...
        //Adding for first time
            ...
            Assignment_4_2_1.models.CartItems item = new CartItems(product.name, variant.price, 1);
    ...
    //Removing products
    public void removeAll(Assignment_4_2_1.models.Product product) {
    ...
    //removing WBP
    public void removeWB(Assignment_4_2_1.models.Product product) {
        //update cart summary
        total -= cartItems.get(product.name).cost();
        noOfItems--;
    ...
    //removing VBP
    public void removeAllVB(Assignment_4_2_1.models.Product product) {
